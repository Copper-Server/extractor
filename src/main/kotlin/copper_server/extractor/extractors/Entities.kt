    ...
    override fun extract(server: MinecraftServer): JsonElement {
        ...
        for (entityType in Registries.ENTITY_TYPE) {
            ...
            if (entity != null) {
                ...
                entityJson.addProperty("is_collidable", entity.isCollidable(null))
            ...
            json.add(Registries.ENTITY_TYPE.getId(entityType).toString(), entityJson)
        }
